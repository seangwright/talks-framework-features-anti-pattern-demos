...
namespace ASPNETCoreMVC.FeatureFocus.Web.Features.Administration.Customers
{
    ...
    public class CustomersAdminController : Controller
    {
        ...
        public CustomersAdminController(ICustomerRepository repository) => this.repository = repository;
        ...
        private async Task<bool> CustomerExists(int id) => (await repository.GetCustomer(id)) != null;
    }
}
